...
const Detail = () => {
    ...
    const route = useRoute(); // Recebe o parâmetro
    ...
    return (
        <SafeAreaView style={{flex: 1}}>
            ...
            <View style={styles.footer}>
                <RectButton
                    style={styles.button}
                    onPress={handlWhatsapp}
                >
                    <FontAwesome name="whatsapp" size={20} color="#FFF"/>
                    <Text style={styles.buttonText}>Whetsapp</Text>
                </RectButton>
                <RectButton
                    style={styles.button}
                    onPress={handlComposeMail}
                >
